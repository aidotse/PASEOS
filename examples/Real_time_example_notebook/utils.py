...
def extract_cpu_time_from_file(file_name):
    ...
    """
    task_name_list=["detect_volcanic_eruptions_async", "PASEOS.advance_time", "check_los_with_ground_station", "ThermalModel.update_temperature", "RadiationModel.did_device_restart", "..odel.did_device_experience_failure"]
    ...
    return dict(zip(["activity", "paseos", "charge", "radiation", "thermal", "los_check"],[time_activity, paseos_activity, charge_model, radiation_time, thermal_model, los_check]))