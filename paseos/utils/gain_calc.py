...
def calc_radio_gain_from_wavelength_diameter(wavelength: float, antenna_diameter: float, antenna_efficiency: float) -> float:
...
def calc_optical_gain_from_wavelength_diameter(wavelength: float, antenna_diameter: float, antenna_efficiency: float) -> float:
    """Calculates antenna gain (directivity) based on wavelength and diameter, valid for parabolic antennas.
