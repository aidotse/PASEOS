...
from paseos.utils.sky_field_sky_coordinate import SkyfieldSkyCoordinate
...
def calc_dist_and_alt_angle_spacecraft_ground(
    ...
    gs_position = (SKYFIELD_EARTH + ground_station_actor._skyfield_position).at(t_skyfield)
...
def calc_dist_and_alt_angle_spacecraft_spacecraft(
    ...
    distance = np.sqrt(
        (local_actor_pos[0] - other_actor_pos[0]) ** 2
        + (local_actor_pos[1] - other_actor_pos[1]) ** 2
