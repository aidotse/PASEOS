...
def is_in_eclipse(
    ...
    """
    logger.debug("Checking whether " + str(actor) + " is in eclipse.")
    ...
    try:
        p1, p2 = actor._central_body_sphere.intersect_line(line_between_sun_and_actor)
        logger.trace("Intersections observed at " + str(p1) + " and " + str(p2))
        if plot:
            plot_3d(
                line_between_sun_and_actor.plotter(t_1=0, t_2=1, c="k"),
