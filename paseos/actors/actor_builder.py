    ...
    def add_comm_device(
        ...
        if bandwidth_in_kbps > 0:
            ...
            if device_type == DeviceType.RADIO_TRANSMITTER:
                ...
                radio_transmitter = RadioTransmitterModel(
                    input_power,
                    power_efficiency,
                    antenna_efficiency,
                    line_losses,
                ...
                radio_receiver = RadioReceiverModel(
                    line_losses,
                    polarization_losses,
                    noise_temperature,
                    antenna_diameter,
                ...
                optical_transmitter = OpticalTransmitterModel(
                    input_power,
                    power_efficiency,
                    antenna_efficiency,
                    line_losses,
                ...
                optical_receiver = OpticalReceiverModel(
                    line_losses, antenna_diameter, antenna_gain
                )
